...
from local_rag_backend.app.application import docs_ingest_use_case
...
async def test_docs_ingest_and_import_endpoints_call_coordinator_execute(
    ...
    monkeypatch.setattr(settings, "retrieval_mode", "sparse", raising=False)
    monkeypatch.setattr(docs_ingest_use_case, "MutationCoordinator", FakeCoordinator, raising=True)
