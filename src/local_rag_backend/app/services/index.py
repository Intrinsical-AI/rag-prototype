...
if TYPE_CHECKING:
    from local_rag_backend.app.services.ports import IndexMutationPorts
...
def rebuild_index_sync(
    *,
    ...
    ports.purge_index_artifacts_fn(index_path=settings_obj.index_path, id_map_path=settings_obj.id_map_path)
