...
from local_rag_backend.app.application.storage_profiles import StorageCapability
from local_rag_backend.app.contracts.ports import MutationRecord
from local_rag_backend.app.contracts.results import MutationSummary, UpsertDocResult
from local_rag_backend.core.domain.types import DocId

if TYPE_CHECKING:
    from collections.abc import Mapping, Sequence

    from local_rag_backend.app.contracts.ports import DocsMutationPorts, MutationJournalPort
